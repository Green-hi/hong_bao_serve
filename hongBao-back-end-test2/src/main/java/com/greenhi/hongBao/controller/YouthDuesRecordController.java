 ...
 */
@RestController
@RequestMapping("/youth-dues-record")
public class YouthDuesRecordController {
    @Autowired
    private YouthDuesRecordService service;

    @RequestMapping(value = "/add",method = RequestMethod.POST)
    public Result add(@RequestBody YouthDuesRecord record){
