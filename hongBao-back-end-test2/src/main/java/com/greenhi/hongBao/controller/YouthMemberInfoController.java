 ...
 */
@RestController
@RequestMapping("/youth-member-info")
public class YouthMemberInfoController {
    @Autowired
    private YouthMemberInfoService service;

    @RequestMapping(value = "/add",method = RequestMethod.POST)
    public Result add(@RequestBody YouthMemberInfo memberInfo){
    ...
    public Result update(@RequestBody YouthMemberInfo youthMemberInfo){
        return service.update(youthMemberInfo);
    }
}
